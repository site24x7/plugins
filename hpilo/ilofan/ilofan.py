...
OIDS = {'fan' : ['cpqHeThermal']}
### OID Attributes
hardware = {'fan' : ['cpqHeFltTolFanIndex','cpqHeFltTolFanLocale','cpqHeFltTolFanPresent','cpqHeFltTolFanType','cpqHeFltTolFanSpeed','cpqHeFltTolFanRedundant','cpqHeFltTolFanRedundantPartner','cpqHeFltTolFanCondition','cpqHeFltTolFanHotPlug','cpqHeFltTolFanHwLocation','cpqHeFltTolFanCurrentSpeed']}
### Output Keys and their units
names = {'fan' : ['index','locale','present','type', {'speed': 'rpm'}, 'redundant','redundantpartner','condition', 'hotplug', 'location',{'currentspeed': 'rpm'}]}
