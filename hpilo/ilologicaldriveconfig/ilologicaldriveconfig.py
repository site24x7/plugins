...
### OID Attributes
hardware = {'drive' : ['cpqDaPhyDrvModel', 'cpqDaPhyDrvFWRev', 'cpqDaPhyDrvBay','cpqDaPhyDrvCondition',  'cpqDaPhyDrvLocation', 'cpqDaPhyDrvPlacement' , 'cpqDaPhyDrvBusNumber', 'cpqDaPhyDrvSerialNum', 'cpqDaPhyDrvType' , 'cpqDaPhyDrvSataVersion', 'cpqDaPhyDrvLocationString', 'cpqDaPhyDrvMediaType']}
### Output Keys and their units
names = {'drive' : ['Model', 'Firmware Revision', 'Bay Location', 'condition', 'Location', 'Placement' , 'SCSI Bus Number', 'Serial Number', 'Type' , 'SATA Version','Location String', 'Media Type']}
