...
OIDS = {'temperature' : ['cpqHeTemperatureIndex']}
### OID Attributes
hardware = {'temperature' : ['cpqHeTemperatureChassis','cpqHeTemperatureIndex','cpqHeTemperatureLocale', 'cpqHeTemperatureThreshold', 'cpqHeTemperatureCondition', 'cpqHeTemperatureThresholdType', 'cpqHeTemperatureHwLocation']}
### Output Keys and their units
names = {'temperature' : ['chassis','index','locale','threshold','condition','thresholdtype','location']}
