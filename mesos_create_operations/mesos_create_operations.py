...
class MesosAgents():
    ...
    def parseClusterData(self, output):
        ...
        try:
            ...
            self.data['dropped'] = data['master/operations/create/dropped']
            self.data['error'] = data['master/operations/create/error']
            self.data['failed'] = data['master/operations/create/failed']
            self.data['finished'] = data['master/operations/create/finished']
            self.data['gone_by_operator'] = data['master/operations/create/gone_by_operator']
            self.data['recovering'] = data['master/operations/create/recovering']
            self.data['total'] = data['master/operations/create/total']
            self.data['unreachable'] = data['master/operations/create/unreachable']
                
            self.data['disk_dropped'] = data['master/operations/create_disk/dropped']
            self.data['disk_error'] = data['master/operations/create_disk/error']
            self.data['disk_failed'] = data['master/operations/create_disk/failed']
            self.data['disk_finished'] = data['master/operations/create_disk/finished']
            self.data['disk_gone_by_operator'] = data['master/operations/create_disk/gone_by_operator']
            self.data['disk_pending'] = data['master/operations/create_disk/pending']
            self.data['disk_recovering'] = data['master/operations/create_disk/recovering']
            self.data['disk_total'] = data['master/operations/create_disk/total']
            self.data['disk_unreachable'] = data['master/operations/create_disk/unreachable']
