...
2. Download plugin from https://raw.githubusercontent.com/site24x7/plugins/master/iDRAC_Powerunit/iDRAC_Powerunit.py
3. Place the plugin in the created folder under agent plugins directory (/opt/site24x7/monagent/plugins/iDRAC_Powerunit)
...
### Powerunits
state, redundancystatus, status, powerconsumption(Watts)
