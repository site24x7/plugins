...
### Monitoring iDRAC Servers - Sensor Performance
...
OIDS = {'sensor' : ['temperatureProbeTable']}
### OID Attributes
hardware = {'sensor' : ['temperatureProbeStateSettings','temperatureProbeStatus','temperatureProbeReading','temperatureProbeLocationName']}
