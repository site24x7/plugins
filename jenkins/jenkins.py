...
class Jenkins(object):
    ...
    def metrics_collector(self):
        try:
            ...
            # Jenkins Version
            self.resultjson["jenkins_version"] = f"{gauges['jenkins.versions.core']['value']}_V"

            # Jobs Metrics
            self.resultjson["jobs_count"] = gauges["jenkins.job.count.value"]["value"]
            self.resultjson["jobs_scheduled_rate"] = meters["jenkins.job.scheduled"]["mean_rate"]
            self.resultjson["jobs_blocked_duration"] = timers["jenkins.job.blocked.duration"]["mean"]
            self.resultjson["jobs_buildable_duration"] = timers["jenkins.job.buildable.duration"]["mean"]
            self.resultjson["jobs_execution_time"] = timers["jenkins.job.execution.time"]["mean"]
            self.resultjson["jobs_queuing_duration"] = timers["jenkins.job.queuing.duration"]["mean"]
            self.resultjson["jobs_total_duration"] = timers["jenkins.job.total.duration"]["mean"]
            self.resultjson["jobs_waiting_duration"] = timers["jenkins.job.waiting.duration"]["mean"]
            ...
            self.resultjson.update({
                ...
                "file_descriptor_ratio": gauges["vm.file.descriptor.ratio"]["value"],
                ...
                "non-heap_memory_commited": gauges["vm.memory.non-heap.committed"]["value"],
                "non-heap_memory_initiated": gauges["vm.memory.non-heap.init"]["value"],
                "maximum_non-heap_memory": gauges["vm.memory.non-heap.max"]["value"],
                "non-heap_memory_used": gauges["vm.memory.non-heap.used"]["value"],
                "total_memory_commited": gauges["vm.memory.total.committed"]["value"],
            ...
            # Performance Metrics
            self.resultjson.update({
                "total_executors_count": gauges["jenkins.executor.count.value"]["value"],
                "executors_free_count": gauges["jenkins.executor.free.value"]["value"],
                "executors_inuse_count": gauges["jenkins.executor.in-use.value"]["value"],
                ...
                "projects_disabled": gauges["jenkins.project.disabled.count.value"]["value"],
                "projects_enabled": gauges["jenkins.project.disabled.count.value"]["value"],
                ...
                "health-check_duration": timers["jenkins.health-check.duration"]["mean"],
                "builds_blocked_duration": timers["jenkins.task.blocked.duration"]["mean"],
                "build_creation_time": timers["jenkins.task.buildable.duration"]["mean"],
                "builds_execution_duration": timers["jenkins.task.execution.duration"]["mean"],
                "builds_queuing_duration": timers["jenkins.task.queuing.duration"]["mean"],
                "builds_waiting_duration": timers["jenkins.task.waiting.duration"]["mean"]
            })

            # Web Metrics
            self.resultjson.update({
                "total_activerequests": counters["http.activeRequests"]["count"],
                "total_badrequest": meters["http.responseCodes.badRequest"]["count"],
                "total_responsecode_created": meters["http.responseCodes.created"]["count"],
                "total_forbidden_responsecode": meters["http.responseCodes.forbidden"]["count"],
                "nocontent_responsecode": meters["http.responseCodes.noContent"]["count"],
                "notfound_responsecode": meters["http.responseCodes.notFound"]["count"],
                "unmodified_responsecode": meters["http.responseCodes.notModified"]["count"],
                "success_responsecode": meters["http.responseCodes.ok"]["count"],
                "non_informational_responsecode": meters["http.responseCodes.other"]["count"],
                "servererror_responsecode": meters["http.responseCodes.serverError"]["count"],
                "service_unavailable": meters["http.responseCodes.serviceUnavailable"]["count"],
