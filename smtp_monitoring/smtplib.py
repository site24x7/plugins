...
class SMTP:
    ...
    def _print_debug(self, *args):
        if self.debuglevel > 1:
            print(datetime.datetime.now().time(), args)
        else:
            print(args)
    ...
    def auth(self, mechanism, authobject, args, initial_response_ok=True):
    ...
    def login(self, user, password, args, initial_response_ok=True):
        ...
        for authmethod in authlist:
            ...
            try:
                (code, resp) = self.auth(
                    authmethod, getattr(self, method_name),None,
