...
In order to change the monitoring configurations, you have two ways to do

### Static

Go to plugins directory and edit the required plugin file.

```
$ cat /opt/site24x7agent/monagent/plugins/mysql/mysql.py
[...]
#Config Section:
...
You can set: `MYSQL_HOST`, `MYSQL_PORT`, `MYSQL_USERNAME` or `MYSQL_PASSWORD`.
